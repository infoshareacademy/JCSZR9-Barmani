...
namespace DrinkItUpWebApp.DAL.Migrations
{
    ...
    [Migration("20230613130646_Authorization2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrinkItUpWebApp.DAL.Entities.Like", b =>
                {
            ...
            modelBuilder.Entity("DrinkItUpWebApp.DAL.Entities.Like", b =>
                {
                    b.HasOne("DrinkItUpWebApp.DAL.Entities.Drink", null)
                        .WithMany("Likes")
                        .HasForeignKey("DrinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DrinkItUpWebApp.DAL.Entities.User", null)
                        .WithMany("Likes")
